...
Scheme
{
	...
	Colors
	{
		...
		"BrightControlText"	"221 221 221 255"	// use for selected controls
		...
		// background colors
		"ControlBG"			"80 80 80 255"		// background color of controls
		"ControlDarkBG"		"51 51 51 255"		// darker background color; used for background of scrollbars

		"WindowBG"			"51 51 51 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"90 90 90 255"	// background color of any selected text or menu item
		"SelectionBG2"		"65 65 65 255"		// selection background in window w/o focus
		"ListBG"			"51 51 51 255"		// background of server browser, buddy list, etc.

		// titlebar colors
		"TitleText"			"255 255 255 255"
		"TitleDimText"		"90 90 90 255"
		"TitleBG"			"80 80 80 0"
		"TitleDimBG"		"80 80 80 0"

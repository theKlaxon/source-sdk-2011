...
public:
	...
	virtual void GetDemoHeaderInfo(char* par1, KeyValues* par2) = 0;
...
// For non-split screen games this will always be zero
	...
	// TODO: find the ACTUAL extra function in tis vtable
	...
	// NEW PAINT STUFF
	virtual void SpherePaintSurfae(model_t* param_1, Vector* param_2, unsigned char param_3, float param_4, float param_5) = 0;

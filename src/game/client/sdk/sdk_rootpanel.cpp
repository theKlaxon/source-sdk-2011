...
// Root panel
//-------------
class C_SDKRootPanel : public Panel {
	typedef Panel BaseClass;
public:
	C_SDKRootPanel( VPANEL parent, int slot );
	~C_SDKRootPanel();
...
C_SDKRootPanel::C_SDKRootPanel( VPANEL parent, int slot )
...
void C_SDKRootPanel::RenderPanelEffects() {
